...
var A_BYTES = Array.from(Buffer.from(
...
var B_BYTES = Array.from(Buffer.from(
...
test("schema-4 state accepts the photo union and snapshots sixty descriptors by reference", async function(){
